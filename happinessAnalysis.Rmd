...
confusionMatrix(factor(resultsDF$predictedDTC5),factor(testData1$Happy))
...
confusionMatrix(factor(resultsDF$predictedRf),factor(testData1$Happy))
...
library(e1071)
# library(fclust)
cmeansCluster <- cmeans(trainData1,centers = 8 ,iter.max = 100, verbose = FALSE,
dist = "manhattan", method = "cmeans", m = 2,
